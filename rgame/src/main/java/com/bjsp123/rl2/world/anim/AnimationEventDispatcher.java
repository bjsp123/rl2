...
final class AnimationEventDispatcher {
    ...
    static void dispatch(Animator animator, Level level, GameEvent ev) {
        ...
        else if (ev instanceof GameEvent.MobTeleported m)         animator.onMobTeleported(level, m);
        ...
        else if (ev instanceof GameEvent.ItemCreated m)           animator.onItemCreated(level, m);
        ...
        else if (ev instanceof GameEvent.ItemFallingIntoChasm m)  animator.onItemFallingIntoChasm(level, m);
        else if (ev instanceof GameEvent.MobFellThroughChasm m)   animator.onMobFellThroughChasm(level, m);
